...
const AddEducation = ({addEducation, history}) => {
    ...
    const [toDateDisabled, togglesDisabled] = useState(false);
        ...
        <Fragment>
            <div>
                ...
                <form className="form" onSubmit={e=>{
                    ...
                    <div className="form-group">
                        <input type="text" placeholder="Field of Styudy" name="fieldofstudy" value={fieldofstudy} onChange={e=>onChange(e)} />
                    </div>
                    <div className="form-group">
                        <h4>From Date</h4>
                    ...
                    <div className="form-group">
                        ...
                        togglesDisabled(!toDateDisabled)
